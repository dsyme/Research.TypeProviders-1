...
The preferred typing algorithm (\S\ref{sec:inference}) is at the core of the type inference 
...
When infering a value from multiple samples, we use the preferred typing relation to find a common 
